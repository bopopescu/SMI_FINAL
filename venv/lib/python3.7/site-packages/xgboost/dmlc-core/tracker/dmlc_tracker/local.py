...
def submit(args):
    ...
    def mthread_submit(nworker, nserver, envs):
        """
        customized submit script, that submit nsubordinate jobs, each must contain args as parameter
        note this can be a lambda function containing additional parameters in input

        Parameters
        ----------
        nworker: number of subordinate process to start up
    ...
    # call submit, with nsubordinate, the commands to run each job and submit function
