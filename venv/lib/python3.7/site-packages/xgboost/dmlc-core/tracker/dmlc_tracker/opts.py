...
def get_opts(args=None):
    ...
    parser.add_argument('--env', action='append', default=[],
                        help='Client and ApplicationMain environment variables.')
    parser.add_argument('--yarn-app-classpath', type=str,
                        help=('Explicit YARN ApplicationMain classpath.' +
    ...
    parser.add_argument('--yarn-app-dir', type=str,
                        ...
                        help=('Directory to YARN appmain. Only used in YARN mode.'))
    parser.add_argument('--mesos-main', type=str,
                        help=('Mesos main, default to ${MESOS_MASTER}')),
